...
const getValidRequestBody = () => ({
    "artifact": {
        ...
        "file": {
            ...
            "fileStore": "59d9a0df-7af5-488d-af8a-3df173cd3304", // This may need to be dynamic
            ...
            "documents": [
                {
                    ...
                    "fileName": "LEGAL_DEMAND_NOTICE",
                    "documentName": "2. Cheque Return Memo - 27_09_2024.png",
                    "fileStoreId": "59d9a0df-7af5-488d-af8a-3df173cd3304"
                }
            ]
        }
    },
...
test.describe('Evidence Creation API Tests - Set 4', () => {
    let apiContext;
