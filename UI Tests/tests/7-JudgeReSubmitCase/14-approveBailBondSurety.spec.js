...
test('Approve Bail Bond Surety', async ({ page }) => {
    ...
    await page.getByRole('button', { name: 'Bail Bonds' }).click();
    await page.getByText('Surety').click();
    ...
    await page.getByText('You have successfully signed the Bail Bond').click();
