...
test('Issue LPR Order', async ({ page }) => {
    ...
    await page.waitForTimeout(1000);
    await page.getByRole('cell', { name: globalVars.lpNumber }).click();
    await page.waitForTimeout(1000);
    ...
    await page.locator('div').filter({ hasText: /^EditDelete$/ }).locator('path').nth(1).click();
    await page.getByText('Moving Case out of Long').click();
