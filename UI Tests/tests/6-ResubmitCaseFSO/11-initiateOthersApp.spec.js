...
test("Dristi Kerala login and initiating others application", async ({ page }) => {
    ...
    // Initiating Others Application
    console.log('Initiating Others Application...');
    ...
    await page.locator('input[name="applicationTitle"]').click();
    await page.locator('input[name="applicationTitle"]').fill('application title');
    await page.getByRole('textbox', { name: 'Type here' }).click();
    await page.getByRole('textbox', { name: 'Type here' }).fill('prayer text');
    await page.locator('.ql-editor').click();
    await page.locator('.ql-editor').fill('details testing');
