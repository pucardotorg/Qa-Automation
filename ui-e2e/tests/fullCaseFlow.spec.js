...
test.describe.serial('Full Case Flow - End to End', () => {
  let globals;
  ...
  test('07 - Naya Mitra collects payment for summons', async ({ page }) => {
    test.setTimeout(180000);
  ...
  test('13 - Court staff e-signs and sends notice', async ({ page }) => {
    test.setTimeout(180000);
  ...
  test('16 - Judge e-signs and sends proclimination', async ({ page }) => {
    test.setTimeout(180000);
