...
test.describe.serial('LPR Orders and moving out from LPR', () => {
    let globals;
    ...
    test('09 - Judge admits case and captures ST number', async ({ page }) => {
        test.setTimeout(600000);
    ...
    // ─────────────────────────────────────────────────────────────────────────────
    // 10 — Judge issues LPR order (Moving Case to Long Pending)
    // Source: UI Tests/tests/9-LPROrders/09-issueLPROrder.spec.js
    // ─────────────────────────────────────────────────────────────────────────────
    test('10 - Judge issues LPR order (Moving Case to Long Pending)', async ({ page }) => {
        test.setTimeout(600000);
        ...
        const lpNumber = await judgeOrders.issueLPROrder(globals.stNumber);

        saveGlobalVariables({ lpNumber });
        console.log('LP Number:', lpNumber);
        globals.lpNumber = lpNumber;
    });

    // ─────────────────────────────────────────────────────────────────────────────
    // 11 — Judge issues order to move case out of Long Pending (LPR)
    // Source: UI Tests/tests/9-LPROrders/10-movingOutFromLPR.spec.js
    // ─────────────────────────────────────────────────────────────────────────────
    test('11 - Judge moves case out of Long Pending (LPR)', async ({ page }) => {
        test.setTimeout(600000);
        ...
        await judgeOrders.moveOutOfLPR(globals.lpNumber);
    });
});